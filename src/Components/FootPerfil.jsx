    ...
    return (
        <>
            <div className="bg-[#AF33EA] flex flex-col items-center justify-between p-10 w-full ">
                ...
                <img className="pt-8 pb-4"  src={person} alt="User" width="36px" height="36px" />
                <label className="text-white text-2xl font-bold pl-1.5 text-center pt-5">User Profile</label>
                </div>
                ...
                <label className="text-white font-normal text-lg p-6">© 2024 AV. Todos los derechos reservados.</label>
            </div>
